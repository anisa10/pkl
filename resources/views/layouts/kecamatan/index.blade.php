    ...
    <div class="row justify-content-center">
        ...
        @if (session('message'))
            ...
            <div class="card">
                ...
                <a href="{{route('kecamatan.create')}}" class="float-right btn btn-success">Add Data</a>
            </div>
                         ...
                         @foreach($kecamatan as $data)
                            <tr>
                                ...
                                <td><form action="{{route('kecamatan.destroy',$data->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <center><a href="{{route('kecamatan.show',$data->id)}}" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></a></i>
